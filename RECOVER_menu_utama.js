...
lib.ssMetadata = [
		{name:"RECOVER_menu_utama_atlas_1", frames: [[0,594,1580,366],[0,962,943,224],[1548,416,357,158],[1058,416,488,146],[945,962,341,138],[1058,0,736,414],[0,0,1056,592],[1796,104,82,82],[1796,188,82,82],[945,1102,338,87],[1796,0,102,102]]}
];
...
(lib.CachedBmp_30 = function() {
	this.initialize(ss["RECOVER_menu_utama_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.RECOVER_menu_utama = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_30 = function() {
		...
		// Aktifkan ekstensi .mp3
		createjs.Sound.alternateExtensions = ["mp3"];
		
		// Daftarkan musik dan tunggu sampai loaded
		createjs.Sound.addEventListener("fileload", handleFileLoad);
		createjs.Sound.registerSound("musikcartoon.mp3", "bgMusic");
		
		var isPlaying = false;
		
		// Sembunyikan tombol OFF saat awal
		this.btnOn.visible = true; // tombol ON harus terlihat di awal
		this.btnOff.visible = false; // tombol OFF harus disembunyikan di awal
		
		function handleFileLoad(event) {
		    console.log("Music file loaded successfully!");
		    // Aktifkan tombol jika musik berhasil dimuat
		    this.btnOn.visible = true;
		}
		
		// Saat tombol ON diklik
		...
		// Saat tombol OFF diklik
		this.btnOff.addEventListener("click", () => {
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/RECOVER_menu_utama_atlas_1.png", id:"RECOVER_menu_utama_atlas_1"},
